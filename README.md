...
2. Sex Ratio (males per 100 females):
   - Examine gender balance across different regions.

3. Age Distribution:

   - Population aged 0–14 years – highlights countries with younger populations.

   - Population aged 60 years and above – identifies nations with aging populations.

4. Population Density:
   - Visualizes the most densely populated countries such as Monaco, Singapore, and Bahrain.
...
>Objective
 ...
 - Analyze and compare global population data.

 - Understand demographic structures by gender and age.

 - Identify high-density regions and potential population growth trends.

Provide a visually interactive and data-driven summary for population research.

<img width="514" height="294" alt="global population analysis power bi" src="https://github.com/user-attachments/assets/e6092ff1-4124-45d2-9b4f-ca06c5fae8d9" />
